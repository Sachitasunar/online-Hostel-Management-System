...
$uid=$_SESSION['login'];
				...
				if($rs)
				{ ?>
			<h4 style="color: red" align="center">Hostel already booked by you! Please make your Payment using global bank on A/C : 034500000123  <br> account name :Nice Hostel </h4>
			<?php }
				else{
					echo "";
							}			
